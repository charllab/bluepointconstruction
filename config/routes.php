...
return [
    'forgotpassword/success' => ['template' => 'forgotpassword-success'],
    'employee-registration' => ['template' => '_registration'],
    'employee-registration/success' => ['template' => '_registration-success'],
];